...
**`EZR012` is the only flag combination worth a diagnostic.** Every other
...
**`EZR013` and `EZR014` are Info, not Warning.** Both describe legitimate,
...
`EZR013` answers the predictable first-run confusion under opt-in defaults — "I
