...
public static class ProviderExtensions
{
    ...
    /// <summary>
    /// Collection shapes supported for nested model properties. All of them back
    /// request DTOs and EF navigations directly, so the property needs a public
    /// getter and setter like any other. Every shape must resolve its element to
    /// a generated <c>{Nested}Dto</c> so the owning type never leaks into the API.
    /// </summary>
